    		...
    		<div className="drawer drawer-mobile scrollbar-hide">
    		  ...
    		  <div className="drawer-content flex justify-start items-center ">
    		  	<label
				    ...
				    <div className="flex flex-col rounded-lg p-5 gap-3 scrollbar-hide bg-gray-200">
    		 	  		{/*here we are supposed to put the content  */}
					    <h1 className="text-2xl font-semibold ml-5">ICT Services</h1>
					    <div className="h-[80vh] w-[70vw] bg-white p-10">
                <div className="mb-10">
                  <hr className="w-full border-t border-gray-400 my-4" />
                  <h2 className="md:text-1xl lg:text-2xl font-bold my-3">Internet and Wifi</h2>
                ...
                <div className="mb-10">
                  <hr className="w-full border-t border-gray-400 my-4" />
                  <h2 className="md:text-1xl lg:text-2xl font-bold my-3">ICT Labs</h2>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et 
                    dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip 
                    ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore 
                    eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia 
                ...
                <div className="mb-10">
                  <hr className="w-full border-t border-gray-400 my-4" />
                  <h2 className="md:text-1xl lg:text-2xl font-bold my-3">Maintenance and Support</h2>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et 
                    dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip 
                    ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore 
                    eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia 
