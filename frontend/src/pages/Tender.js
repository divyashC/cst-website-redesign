...
const TenderComponent = ({ imageSrc, views, date, title, content }) => {
  ...
  return (
    <div className="flex items-center justify-center w-[640px] mb-[100px] h-auto p-4 cursor-pointer bg-white hover:bg-[#D4D4D4] rounded-[20px]" onClick={() => window.location.href='/tender'}>
